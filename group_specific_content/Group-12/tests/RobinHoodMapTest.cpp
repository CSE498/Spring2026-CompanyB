...
TEST_CASE("Erase by iterator removes element", "[erase]") {
    RobinHoodMap<int, int> map;
    map.insert(1, 100);
    map.insert(2, 200);
    map.insert(3, 300);
...
TEST_CASE("Erase by iterator returns next element", "[erase]") {
    RobinHoodMap<int, int> map;
    map.insert(1, 100);
    map.insert(2, 200);
    map.insert(3, 300);
...
TEST_CASE("Erase all elements via iterator", "[erase]") {
    RobinHoodMap<int, int> map;
    map.insert(1, 100);
    map.insert(2, 200);
    map.insert(3, 300);
...
TEST_CASE("Erase in loop with conditional", "[erase]") {
    RobinHoodMap<int, int> map;
    for (int i = 0; i < 10; ++i) {
        map.insert(i, i * 10);
    }
...
TEST_CASE("Erase from single element map", "[erase]") {
    RobinHoodMap<int, int> map;
    map.insert(42, 100);
