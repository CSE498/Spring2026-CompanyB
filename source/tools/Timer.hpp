 ...
 * and stop, but also be giving a name for the timing, it can track multiple
 * different times and compare them as needed. It can also pause and resume the
 * timing measurements if needed. Citation: Used AI responsibly and actively in
 * building the class below.
 */
namespace cse498 {
class Timer {
 public:
