 ...
 *
 * - A child returns Status::Failure -> the sequence immediately returns
 * Status::Failure.
 * - A child returns Status::Running -> the sequence returns Status::Running and
 * resumes from that child on the next tick.
 * - All children return Status::Success -> the sequence returns
 * Status::Success.
 *
