 ...
 * @brief API class for writing logs and statistics to JSON and console with configurable log levels.
...
namespace cse498 {
    ...
    /// @brief Log verbosity: controls whether messages go to file, console, or both.
    enum class LogLevel {
        Silent,   ///< No output
    ...
    private:
        ...
        /// @brief Ensures the output file is open for writing; no-op if path empty or already open.
    ...
    public:
        ...
        /// @brief Records a log message at the given level; writes to file and/or console per current log level.
        ...
        /// @brief Writes the complete log and computed statistics from DataLog to JSON file and console.
        /// Called by DataLog::WriteToOutput() at the end of a simulation run.
