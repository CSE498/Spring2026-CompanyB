...
class Entity {
 ...
 public:
  ...
  /// Is this Entity actually an autonomous agent? (Overridden in AgentBase to
  /// return true)
  ...
  /// Is this Entity actually a specialty Agent that's an Interface for a human
  /// player? (Overridden in InterfaceBase to return true)
