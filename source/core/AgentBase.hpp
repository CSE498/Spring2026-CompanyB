...
public:
   ...
   */
  [[nodiscard]] DataClass GetState() const noexcept { return m_Data; }
 ...
 public:
  ...
  /// @brief Run AFTER the world configures the agent, for additional tests or
  /// setup.
  ...
  /// @brief Decide the next action for this agent to perform; must be
  /// overridden!
  ...
  /// @param msg_type Category of message, such as "item_alert", "damage", or
  /// "enemy"
