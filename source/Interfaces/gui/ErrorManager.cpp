...
ErrorManager::ErrorManager(OutputMode mode) : m_outputMode(mode) {}
...
void ErrorManager::setOutputMode(OutputMode mode) { m_outputMode = mode; }
...
const ErrorManager::ErrorHandler& ErrorManager::getHandler(
...
void ErrorManager::defaultHandler(const std::string& message,
                                  Severity severity) const {
