...
void MainGraph::ShowLineGraph(const QString& title, const QString& seriesName,
                              const std::vector<double>& data, QColor color) {
...
void MainGraph::ShowPieChart(
    const QString& title, const std::vector<std::pair<QString, double>>& slices,
