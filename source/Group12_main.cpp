...
//
//// // Still needs more work, gotta figure out how we want SwarmingAgents to
/// act / in / // the infectiious world, but this is a start / struct
/// DiseaseData { /   double infection_probability; /   cse498::HealthState
/// infection_state; /   std::optional<cse498::WorldPosition> destination; /
/// cse498::WorldPosition position; /   cse498::Direction direction; / };
//
// int main() {
...
//  MazeWorld world;
//
//  //   world.AddAgent<PacingAgent>("Pacer 1").SetLocation(WorldPosition{3,
//  1});
//  //   world.AddAgent<PacingAgent>("Pacer 2").SetLocation(WorldPosition{6,
//  1});
