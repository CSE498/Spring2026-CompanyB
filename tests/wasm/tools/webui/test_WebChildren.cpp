...
TEST_CASE("WebLayout adds children from WebOptions", "[WebLayout][WebOptions]") {
  ...
  emscripten::val btn1 = document.call<emscripten::val>("getElementById", std::string("child-btn-1"));
  emscripten::val btn2 = document.call<emscripten::val>("getElementById", std::string("child-btn-2"));
