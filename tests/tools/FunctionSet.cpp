// ATTRIBUTIONS: I used Chat GPT to generate the base test cases. I did modify
// them, however.
...
TEST_CASE("FunctionSet - Initializer list construction") {
  cse498::FunctionSet<int, int> fs = {[](int x) { return x * 2; },
                                      [](int x) { return x + 1; },
                                      [](int x) { return x - 1; }};
...
TEST_CASE("FunctionSet - Invoke all functions with void return") {
  int counter = 0;
...
TEST_CASE("FunctionSet - Invoke all functions with storable return") {
  int counter = 0;
  cse498::FunctionSet<int, int> fs;
...
TEST_CASE("FunctionSet - Index access with operator[]") {
  cse498::FunctionSet<int, int> fs = {[](int x) { return x * 3; },
                                      [](int x) { return x - 2; }};
...
TEST_CASE("FunctionSet - invoke_catch with no errors, non storable return") {
  int result = 0;
  cse498::FunctionSet<void, int> fs;
...
TEST_CASE("FunctionSet - invoke_catch with no errors, storable return") {
  int result = 0;
  cse498::FunctionSet<int, int> fs;
...
TEST_CASE("FunctionSet - front and back") {
  cse498::FunctionSet<int, int> fs = {[](int x) { return x * 10; },
                                      [](int x) { return x * 20; },
                                      [](int x) { return x * 30; }};
...
TEST_CASE("FunctionSet - iteration") {
  cse498::FunctionSet<int, int> fs = {[](int x) { return x * 1; },
                                      [](int x) { return x * 2; },
                                      [](int x) { return x * 3; }};
