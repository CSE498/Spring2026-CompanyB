 ...
 *  However, unless specified on a test case/section, the tests were manually
...
TEST_CASE("Tokenize: Invalid expressions", "[tokenize]") {
  SECTION("Invalid character") {
    REQUIRE_THROWS_AS(cse498::ExpressionParser("3 + 4 * x @"),
                      cse498::ExpressionException);
  }

  SECTION("Unclosed index") {
    REQUIRE_THROWS_AS(cse498::ExpressionParser("{0 + 1"),
                      cse498::ExpressionException);
  }

  SECTION("Empty index") {
    REQUIRE_THROWS_AS(cse498::ExpressionParser("{} + 1"),
                      cse498::ExpressionException);
  }

  SECTION("Single-character operator") {
    REQUIRE_THROWS_AS(cse498::ExpressionParser("x = 5"),
                      cse498::ExpressionException);
  }
  ...
  SECTION("Invalid index format") {
    REQUIRE_THROWS_AS(cse498::ExpressionParser("{abc} + 1"),
                      cse498::ExpressionException);
  }

  SECTION("Inalid operator '!'") {
    REQUIRE_THROWS_AS(cse498::ExpressionParser("!x + 1"),
                      cse498::ExpressionException);
  }
...
TEST_CASE("Parse: Valid expressions", "[parse]") {
  ...
  SECTION("Simple expression") {
    ...
    REQUIRE_THAT(func(arr, vars), Catch::Matchers::WithinRel(11.0));
  }
  ...
  SECTION("Precedence and associativity") {
    ...
    REQUIRE_THAT(func(arr, vars), Catch::Matchers::WithinRel(4.0));

    parser.setRawExpression("12 / 3 / 2");
    func = parser.parse();

    REQUIRE_THAT(func(arr, vars), Catch::Matchers::WithinRel(2.0));

    parser.setRawExpression("2 ^ 3 ^ 2");
    func = parser.parse();

    REQUIRE_THAT(func(arr, vars), Catch::Matchers::WithinRel(512.0));

    parser.setRawExpression("100 / 10 * 2");
    func = parser.parse();

    REQUIRE_THAT(func(arr, vars), Catch::Matchers::WithinRel(20.0));

    parser.setRawExpression("(3 + 4) * 2");
    func = parser.parse();

    REQUIRE_THAT(func(arr, vars), Catch::Matchers::WithinRel(14.0));

    parser.setRawExpression("2 + 3 % 2");
    func = parser.parse();

    REQUIRE_THAT(func(arr, vars), Catch::Matchers::WithinRel(3.0));

    parser.setRawExpression("2 + 3 * 4 ^ 2");
    func = parser.parse();

    REQUIRE_THAT(func(arr, vars), Catch::Matchers::WithinRel(50.0));
  }
  ...
  SECTION("Logical and relational operators") {
    ...
    REQUIRE_THAT(func(arr, vars), Catch::Matchers::WithinRel(1.0));

    vars["x"] = 4;
    REQUIRE_THAT(func(arr, vars), Catch::Matchers::WithinRel(0.0));
  ...
  SECTION("Expression with variables, indices, and literals") {
    ...
    REQUIRE_THAT(func(arr, vars), Catch::Matchers::WithinRel(60.0));
    ...
    REQUIRE_THAT(func(arr, vars), Catch::Matchers::WithinRel(6.5));
    ...
    REQUIRE_THAT(func(arr, vars), Catch::Matchers::WithinRel(10.0));
    ...
    REQUIRE_THAT(func(arr, vars), Catch::Matchers::WithinRel(80.0));
  }
}
...
TEST_CASE("Parse: Invalid expressions", "[parse]") {
  ...
  SECTION("Missing variables") {
    ...
    vars["x"] = 2;
    REQUIRE_THAT(func(arr, vars), Catch::Matchers::WithinRel(7.0));
  ...
  SECTION("Index out of bounds or missing") {
    ...
    arr.push_back(2.5);
    REQUIRE_THAT(func(arr, vars), Catch::Matchers::WithinRel(7.5));
  }
  ...
  SECTION("Division by zero") {
    ...
    vars["x"] = 2;
    REQUIRE_THAT(func(arr, vars), Catch::Matchers::WithinRel(5.0));
  }
