...
// g++ -std=c++23 -Wall -Wextra -I../../../third-party/Catch/single_include
// AnnotationSet.cpp AnnotationSetTest.cpp -o AnnotationSetTest.exe
...
TEST_CASE("AddTag multiple elements", "[addTag]") {
  ...
  CHECK(s.getTags() ==
        std::unordered_set<std::string>{"fancy", "groovy", "slick"});
}
