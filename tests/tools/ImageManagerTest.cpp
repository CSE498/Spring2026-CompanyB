...
// static const QString kImg1 =
// QString::fromStdString(std::string(TEST_IMAGE_DIR)) + "/test1.png"; static
// const QString kImg2 = QString::fromStdString(std::string(TEST_IMAGE_DIR)) +
// "/test2.png";
...
//   cse498::ImageManager manager1;
//   CHECK(manager1.Load("image1", kImg1));
//   CHECK(manager1.Load("image2", kImg2));
